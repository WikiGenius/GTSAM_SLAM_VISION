%class BetweenFactorLieMatrix, see Doxygen page for details
%at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
%
%-------Constructors-------
%BetweenFactorLieMatrix(size_t key1, size_t key2, LieMatrix relativePose, Base noiseModel)
%
%-------Methods-------
...
%measured() : returns gtsam::LieMatrix
...
classdef BetweenFactorLieMatrix < gtsam.NoiseModelFactor
  ...
  methods
    function obj = BetweenFactorLieMatrix(varargin)
      ...
      obj.ptr_gtsamBetweenFactorLieMatrix = my_ptr;
    end
