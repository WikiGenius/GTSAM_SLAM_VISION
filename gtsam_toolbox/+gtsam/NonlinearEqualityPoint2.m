  ...
  methods
    function obj = NonlinearEqualityPoint2(varargin)
      ...
      elseif nargin == 2 && isa(varargin{1},'numeric') && isa(varargin{2},'gtsam.Point2')
        [ my_ptr, base_ptr ] = gtsam_wrapper(1862, varargin{1}, varargin{2});
      elseif nargin == 3 && isa(varargin{1},'numeric') && isa(varargin{2},'gtsam.Point2') && isa(varargin{3},'double')
        [ my_ptr, base_ptr ] = gtsam_wrapper(1863, varargin{1}, varargin{2}, varargin{3});
      else
    ...
    function delete(obj)
      gtsam_wrapper(1864, obj.ptr_gtsamNonlinearEqualityPoint2);
    end
  ...
  methods(Static = true)
    function varargout = string_deserialize(varargin)
      ...
      if length(varargin) == 1
        varargout{1} = gtsam_wrapper(1876, varargin{:});
      else
